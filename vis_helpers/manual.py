...
def show_manual():
    ...
    # st.header('Portfolios Uploaded do Database')
    ...
    #     st.markdown('<b>Name of column</b> will be displayed as a <b>name of a plot in the legend</b>',
    #                 unsafe_allow_html=True)
    #     st.markdown("Do not duplicate names of the columns", unsafe_allow_html=True)
    ...
    #     st.markdown('<b>Name of a file</b> will be displayed as a <b>name of a plot in the legend</b>',
    #                 unsafe_allow_html=True)
